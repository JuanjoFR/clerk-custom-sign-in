...
export function AuthCarousel() {
  return (
    ...
    >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 pb-20 text-white">
              <div className="max-w-md">
                <h2 className="mb-6 text-2xl font-bold md:text-4xl">
                  ...
                  they&apos;re bogged down with design debt, we&apos;re
        ...
        <CarouselItem key="2">
          <div className="relative h-screen w-full overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-8 pb-20 text-white">
              <div className="max-w-md">
                <h2 className="mb-6 text-2xl font-bold md:text-4xl">
                  Our platform has transformed how we collaborate with clients
      ...
      <div className="absolute right-24 bottom-8 z-10 flex">
